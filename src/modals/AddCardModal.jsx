...
// Helpers function getVariantLabel(card) {
...
// Component export default function AddCardModal({ onClose, prefill, user, isAdmin, collection, setCollection, showToast }) {
// Step 1 — name search
...
// Derived data // Group printings by set_name, preserve first-seen order
const setGroups = []
...
// Build card object from current form state function buildCard() {
...
// Admin: Add to collection + list in store async function handleSubmitAndList(e) {
e.preventDefault()
if (!canSubmit) return
const card = buildCard()
try {
...
// Foil availability for selected card const finishes = selectedCard?.finishes || []
