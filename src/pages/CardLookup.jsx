...
// Rarity helpers const RARITY_ORDER = { mythic: 0, rare: 1, uncommon: 2, common: 3, special: 4, bonus: 5 }
...
// Wishlist helper async function addCardToWishlist(card, showToast, user) {
try {
...
// Printing thumbnail card (horizontal scroll) function PrintingCard({ printing, isSelected, onSelect }) {
...
// Card Detail View function CardDetailView({ card, printings, printingsLoading, onBack, openAddCard, showToast, onPrintingSelect, user, onStoreSearch }) {
...
// Set Card List View function SetView({ set, onBack, onCardSelect }) {
...
// Search View function SearchView({ onBack, onCardSelect }) {
...
// Main Component // Recently viewed helpers const RV_KEY = 'vs-recently-viewed'
const RV_MAX = 8
...
// sessionStorage helpers for persisting open-card state across remounts const SS_VIEW = 'vs-cl-view'
...
// Render if (view === 'card' && cardDetail) {
return (
<CardDetailView
card={cardDetail}
printings={printings}
