...
// Helpers const TODAY = new Date().toISOString().slice(0, 10)
...
// Set type metadata const TYPE_META = {
...
// Set icon component function SetIcon({ uri, size = 28 }) {
...
// Single set card function SetCard({ set, showCountdown = false }) {
...
// Section header function SectionHeader({ icon, title, count }) {
return (
<div style={{
...
// Main component export default function SetReleases() {
