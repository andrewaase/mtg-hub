...
// Add friend const handleFindUser = async () => {
...
// Remove friend const handleRemoveFriend = async (friendRow) => {
...
// Browse collection const handleBrowse = async (friendRow) => {
...
// Cart const handleAddToCart = (card) => {
setCart(prev => {
...
// Respond to trade const handleRespondTrade = async (trade, action, opts = {}) => {
const token = await getToken()
const myName = user.email?.split('@')[0] || 'Someone'
...
// Report user const handleSubmitReport = async () => {
...
// Derived const filteredCollection = friendCollection.filter(c =>
