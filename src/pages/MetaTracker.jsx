...
const CAT_STYLE = {
'AGGRO': { border: '#ef4444', bg: 'rgba(127,29,29,0.30)', text: '#fca5a5', emoji: '' },
'CONTROL': { border: '#3b82f6', bg: 'rgba(30,58,138,0.30)', text: '#93c5fd', emoji: '' },
...
// Sub-components function TrendArrow({ trend }) {
...
// Spike Predictor sub-component const SIGNAL_STYLE = {
...
// Client-side ingest helpers const INGEST_FORMATS = ['modern', 'standard', 'pioneer', 'legacy', 'pauper']
...
// SpikePredictor component function SpikePredictor() {
...
<div style={{ color: '#fca5a5', fontWeight: 600, marginBottom: 8 }}> {spikeError}</div>
...
// Main component export default function MetaTracker() {
