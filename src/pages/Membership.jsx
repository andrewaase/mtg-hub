...
// Subscribe (Stripe Checkout) const handleSubscribe = async () => {
...
// Manage billing (Stripe Customer Portal) const handleManageBilling = async () => {
setLoading('portal')
try {
const { data: { session } } = await supabase.auth.getSession()
...
// Redeem free months const handleRedeem = async () => {
