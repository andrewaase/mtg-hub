...
// Accept friend request async function handleAccept(e, n) {
e.stopPropagation()
...
// Deny friend request async function handleDeny(e, n) {
e.stopPropagation()
const fromUserId = n.data?.fromUserId
setActing(n.id)
try {
...
// Dismiss single notification async function handleDismiss(e, n) {
e.stopPropagation()
await deleteNotification(n.id)
setNotifications(prev => prev.filter(x => x.id !== n.id))
}
// Clear all async function handleClearAll() {
await deleteAllNotifications(user.id)
setNotifications([])
}
// Click notification row async function handleRowClick(n) {
if (!n.read) {
